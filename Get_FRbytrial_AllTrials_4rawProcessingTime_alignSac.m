function [FR_temp1, FR_temp2, FR_temp3, FR_temp4, ntrs_temp] = Get_FRbytrial_AllTrials_4rawProcessingTime_alignSac(filename,class_num)
%16-May-2020, J Zhu
...
epoch_start = -0.2;
epoch_end = -0.04; % the certain time period
