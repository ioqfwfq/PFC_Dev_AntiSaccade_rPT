function Neuron_Data_latency_AntiSaccade_sameneuron_rPT_aligncue
...
for n = 1:length(Neurons)
    ...
    try
        [ltc1_temp, ltc2_temp, ltc3_temp, ltc4_temp, ntrs_temp] = Get_Latency_AllTrials_4rawProcessingTime_alignCue(Antifilename,Best_Cue(n));
        ltc1 = [ltc1 ltc1_temp];
        ltc2 = [ltc2 ltc2_temp];
        ltc3 = [ltc3 ltc3_temp];
        ltc4 = [ltc4 ltc4_temp];
