function p = Neuron_Data_multiFRbyneuron_AS_sameneuron_4rPT_aligncue
% For AntiSaccade task
% calculate the firing rate of certain *epoches* of certain trails
...
%    Errfilename = [Neurons{n,1}(1:6),'_2_',num2str(Neurons{n,2}),'_erriscuesac'];
    try
        [FR_temp1, FR_temp2, FR_temp3, FR_temp4, ntrs_temp] = Get_multiFRbyneuron_AllTrials_4rawProcessingTime_alignCue(Antifilename,Best_Cue(n));
