...
% Update plotting. Plot best target location with its oppo location together
...
for n = 1:length(Neurons)
    ...
    try
        [psth_temp1, psth_temp2, psth_temp3, psth_temp4, ntrs_temp] = Get_PsthM_combine_RT(Antifilename,Opp_Cue(n)+8,Opp_Cue(n)+16);
        psth2(n,:) = psth_temp1;
        psth4(n,:) = psth_temp2;
        psth6(n,:) = psth_temp3;
        psth8(n,:) = psth_temp4;
...
text(0.5, 0, 'Motor neurons Align Sac Best target location/opposite location', 'FontSize', 12', 'FontWeight', 'Bold', ...
