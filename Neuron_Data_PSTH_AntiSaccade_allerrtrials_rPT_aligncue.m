function Neuron_Data_PSTH_AntiSaccade_allerrtrials_rPT_aligncue
...
legend('\color{cyan} CueIn','\color{magenta} CueOut')
...
set( gca, 'Color', 'None') ;
text( 0.5, 0, 'PFC neurons Align Cue Best cue location/opposite location', 'Color', 'k', 'FontSize', 12', 'FontWeight', 'Bold', ...
